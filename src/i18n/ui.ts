...
export const ui = {
  en: {
    ...
    "nav.invest": "Why invest in tulum?",
    "nav.blog": "Blog",
    "nav.contact": "Contact",
    "descriptionSection.title": "Residential development in Tulum",
    ...
    "sustainability.card3":
      "Renewable energy for the lighting of driveways and power of amenities.",
    ...
    "mapPlanoModal.height.meters": "meters",
    ...
    "homeDesign.SerenityData": `
        ...
        <b>starting price US $31,000</b>`,
    "homeDesign.Tranquility": "Tranquility",
    "homeDesign.TranquilityData": `
      <ul>
        <li>26 units</li>
        <li>300+ m<sup>2</sup></li>
      </ul>
      <b>starting price US $78,000</b>`,
    "homeDesign.Harmoney": "Harmony",
    "homeDesign.HarmonyData": `
      <ul>
        <li>20 units</li>
        <li>400+ m<sup>2</sup></li>
      </ul>
      <b>starting price US $118,000</b>
      `,
  },
  es: {
    "nav.home": "Inicio",
    ...
    "nav.invest": "¿Por quÉ invertir en Tulum?",
    "nav.contact": "Contacto",
    "descriptionSection.title": "Desarrollo residencial en Tulum",
    ...
    "mapPlanoModal.height.meters": "metros",
    ...
    "homeDesign.Tab1": "Casas",
    "homeDesign.Tab2": "Terrenos",
    "homeDesign.Serenity": "Serenity",
    "homeDesign.SerenityData": `
        <ul>
          <li>19 unidades</li>
    ...
    "homeDesign.TranquilityData": `
      ...
      <b>Precio inicial US $78,000</b>`,
    "homeDesign.Harmony": "Harmony",
    "homeDesign.HarmonyData": `
      <ul>
        <li>20 unidades</li>
        <li>400+ m<sup>2</sup></li>
      </ul>
      <b>Precio inicial US $118,000</b>
      `,
  },
} as const;
